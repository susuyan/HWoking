...
//    return string;
    ...
    if ([string rangeOfString:@"移动"].length != 0) {
        return @"移动";
    }else if ([string rangeOfString:@"联通"].length != 0) {
        return @"联通";
    }else if ([string rangeOfString:@"电信"].length != 0){
        return @"电信";
    }else if ([string rangeOfString:@"电话"].length != 0){
        return @"固话";
    }
    return string;
}
