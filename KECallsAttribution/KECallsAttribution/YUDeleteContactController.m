...
@interface YUDeleteContactController ()<UIAlertViewDelegate>
...
@implementation YUDeleteContactController
...
- (void)initNavBarItem {
    UIBarButtonItem *backItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"back_button"] style:UIBarButtonItemStyleDone target:self action:@selector(backHomeAction)];
    self.navigationItem.leftBarButtonItem = backItem;

    
    UIBarButtonItem *deleteItem = [[UIBarButtonItem alloc] initWithTitle:@"删除" style:UIBarButtonItemStyleDone target:self action:@selector(deleteAction)];
