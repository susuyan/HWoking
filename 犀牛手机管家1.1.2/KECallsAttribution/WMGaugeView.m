...
- (void)drawFace:(CGContextRef)context
{
    switch (_innerBackgroundStyle)
    {
        ...
        case WMGaugeViewInnerBackgroundStyleFlat:
        {
            ...
            CGContextSetFillColorWithColor(context, CGRGB(255, 255, 255));
            ...
            CGContextSetFillColorWithColor(context, CGRGB(2, 130, 226));
            CGContextFillPath(context);
        }
        break;
...
- (void)drawNeedle:(CGContextRef)context
{
    ...
    switch (_needleStyle)
    {
        ...
        case WMGaugeViewNeedleStyleFlatThin:
        {
            ...
            [RGB(3, 175, 235) setFill];
            [RGB(3, 175, 235) setStroke];
            [needlePath fill];
            needlePath.lineWidth = 0.004;
            [needlePath stroke];
        }
